 ...
 */
const applyCursorsToNodes = (allNodesAccessor, {
  before,
  after,
}, {
...
const nodesToReturn = async (allNodesAccessor, {
  removeNodesBeforeAndIncluding,
  removeNodesAfterAndIncluding,
...
const apolloCursorPaginationBuilder = ({
  ...
  const {
    ...
    hasPreviousPage,
    hasNextPage,
  } = await nodesToReturn(allNodesAccessor, {
    removeNodesBeforeAndIncluding,
    removeNodesAfterAndIncluding,
    getNodesLength,
    hasLengthGreaterThan,
